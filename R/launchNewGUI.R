  ...
  ui <- shiny::fluidPage(
    ...
    shiny::tabsetPanel(
      ...
      shiny::tabPanel("Data cleaning",
                      ...
                      shiny::fluidRow(
                        shiny::column(width = 3, shiny::numericInput("l.VWC",
                                                                     label = "Min stem VWC accepted (%)",
                                                                     min = -1, 
                                                                     max = 100,
                                                                     step = 1,
                                                                     value = 0)),
                        shiny::column(width = 3, shiny::numericInput("h.VWC",
                                                                     label = "Max stem VWC accepted (%)",
                                                                     min = 0, 
                                                                     max = 150,
                                                                     step = 1,
                                                                     value = 100)),
  ...
  server <- function(input, output){
    ...
    dati_clean <- shiny::eventReactive(input$pulisci,
                                   convertStringsEnsemble(
                                     ...
                                     lower.VWC = input$l.VWC,
                                     higher.VWC = input$h.VWC,
                                     species = input$species_input,
                                     tz = input$timezone_input,
                                     startdate = input$datasetstartdate,
                                     enddate = input$datasetenddate
                                   ))
